...
class VendingMachine:
    ...
    def vend(self):
        if self.amount<=0:
        ...
        elif self.payed<self.price:
            return 'You must deposit $'+str(self.price-self.payed)+' more.'
        elif self.payed==self.price:
            self.amount-=1
            self.payed = 0
            ...
            self.amount-=1
            res = str(self.payed-self.price)
            self.payed=0
            return 'Here is your candy and '+'$'+res+' change.'
    ...
    def deposit(self, money):
        if self.amount<=0:
            ...
            self.payed += money
            return 'Current balance: $'+str(self.payed)
...
def generate_paths(t, x):
    ...
    for bran in t.branches:
        for i in generate_paths(bran,x):
            yield ([t.label]+i)
